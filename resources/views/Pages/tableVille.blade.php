    ...
    <div class="card p-2 mb-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-11 col-md-6">
                ...
                <form class="form-inline mt-2 ml-2 float-right mr-4 ml-2" action="{{URL::to('searchville')}}" method="get" role="search">
                        {{ csrf_field() }}
    ...
    <!--Top Table UI-->
        ...
        <div class='table-responsive mt-5'>
                ...
                <!--Table head-->
                  <!--Table body-->
                  <tbody>
                      @foreach($Tville as $Tvilles)
                      <tr align="center">
                          
                          <td>{{ $Tvilles->nomVille }}</td>
                          <td>{{ $Tvilles->nomPays }}</td>
                          
                          <td>
                            <div class="d-flex justify-content-center">
                                <div class="p-2">
                          <form action="{{url('villes/'.$Tvilles->id)}}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('DELETE')}}
                            <button type="submit" class="btn btn-outline-danger waves-effect px-3 mt-auto" onclick="return confirm('Voulez vous supprimer ?')"><i class="fa fa-times" aria-hidden="true"></i></button>
                               ...
                               <div class="p-2">
                        <a type="button" href="{{url('Tvilles/'.$Tvilles->id.'/modifierTable')}}" class="btn btn-outline-success waves-effect px-3 mt-auto"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                </div>
                            ...
                            <tr align="center">
                                ...
                                <form action="{{url('villes/'.$villes->id)}}" method="POST">
                                  ...
                                  <button type="submit" class="btn btn-outline-danger waves-effect px-3 mt-auto" onclick="return confirm('Voulez vous supprimer ?')"><i class="fa fa-times" aria-hidden="true"></i></button>
                                     ...
                                     <div class="p-2">
                              <a type="button" href="{{url('Tvilles/'.$villes->id.'/modifierTable')}}" class="btn btn-outline-success waves-effect px-3 mt-auto"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                      </div>
